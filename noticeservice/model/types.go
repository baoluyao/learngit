...
/*
type STRING = cockroachtype.STRING
type INT64 = cockroachtype.INT64
type DATE = cockroachtype.DATE
type DATETIME = cockroachtype.DATETIME
type FLOAT64 = cockroachtype.FLOAT64
type BOOL = cockroachtype.BOOL
type JSONB = cockroachtype.JSONB
type StringArray = cockroachtype.StringArray
type Int64Array = cockroachtype.Int64Array
*/
...
func SetString(ss string) STRING {
	var t STRING
	t.NullString.Valid = true
	t.NullString.String = ss
	return t
...
func SetInt64(ii int64) INT64 {
	var t INT64
	t.NullInt64.Valid = true
	t.NullInt64.Int64 = ii
	return t
}
...
func SetFloat64(ss float64) FLOAT64 {
	var t FLOAT64
	t.NullFloat64.Valid = true
	t.NullFloat64.Float64 = ss
	return t
}
...
func SetJSONB(json map[string]interface{}) JSONB {
	var t JSONB
	t.KV = json
	return t
}
...
// 	if t.String() != "00000000-0000-0000-0000-000000000000" {
