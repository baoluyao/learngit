...
var (
	...
	ServerError      = NewError(110000000, "server error")                     //500
	NgIOTServerError = NewError(110000002, "ngiot server account login error") //500
	InvalidParams    = NewError(110000001, "invalid params")                   //400
	...
	UnauthorizedAuth         = NewError(110000020, "Unauthorized Auth")         //401
	...
	FileRemoveError       = NewError(118000007, "file remove error")
	...
	MapAlreadyInGroup   = NewError(119000005, "map already in group")
	MapAlreadyUsed      = NewError(119000006, "map already been used")
	//common
	...
	ElevatorNotExist     = NewError(123000002, "elevator not exist")
	ElevatorhasConfig    = NewError(123000003, "elevator already have Config") /////newadd
	ElevatorAlreadyExsit = NewError(123000004, "elevator already exist")       /////newadd
	//map
	...
	//abnormal
	DBOperationError     = NewError(130000001, "sql operation exception") //db  operation error
	AbnormalCodeNotExist = NewError(130000002, "abnormalcode not exist")
	...
	BuildingWifiNotExist      = NewError(150000004, "buiding wifi not exist")
	BuildingAlreadyUsed       = NewError(150000005, "buiding already used")
	BuildingFloorAlreadyUsed  = NewError(150000006, "buiding floor already used")
	BaseStaionNotExist        = NewError(150000007, "baseStaion not exist")

	RobotGroupNotExist     = NewError(160000001, "robot group not exist")
	RobotGroupAlreadyExist = NewError(160000002, "robot group name already exist")
	RobotGroupAlreadyUsed  = NewError(160000003, "robot group already used")

	LogRecordNotExist   = NewError(170000001, "log record not exist")
	VideoRecordNotExsit = NewError(170000002, "video record not exist") /////newadd

	LegalCheckError = NewError(180000001, "敏感词接口调取异常")
	TextIsUnLegal   = NewError(180000002, "内容存在敏感词")

	GateNotExist     = NewError(190000001, "gate not exist")
	GatehasConfig    = NewError(190000002, "gate already have Config") /////newadd
	GateAlreadyExsit = NewError(190000003, "gate already exist")       /////newadd
